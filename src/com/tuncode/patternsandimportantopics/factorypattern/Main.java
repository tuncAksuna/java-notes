 ...
 * yapýdaki nesnelerin üretimini gerçekleþtiren sýnýflarýn bir soyut sýnýftan(interface) üretilmesini saðlamak da performansý arttýcaktýr !

 * Nesneyi yaratma, newleme iþlemini Factory classýna veririz
 * Nesne yaratma iþlemi için bir interface tasarlanmasýný gerektirir ve alt sýnýflarýn bu interface üzerinden nesne üretmesine olanak saðlar.
