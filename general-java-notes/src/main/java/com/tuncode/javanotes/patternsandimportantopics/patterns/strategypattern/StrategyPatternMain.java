package com.tuncode.javanotes.patternsandimportantopics.patterns.strategypattern;

import java.math.BigDecimal;

/**
 * @description : Strategy pattern bir algoritmay� (ornegin bir file format converter uygulamasinde dosyalar
 ...
 * kapsulleyerek birbiriyle degistirebilir hale getirir ve bu sayede nesnenin davranisini "dinamik" olarak degistebilme imkani tanir. �rne�in: Bir odeme sisteminde farkli odeme yontemleri farkl� algoritmalar gerektirir. Her odeme yontemi icin ayr� bir strateji sinifi olusturmam�za ve client tarafindan kullanilacak olan
